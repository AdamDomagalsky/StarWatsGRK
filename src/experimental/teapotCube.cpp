...
// wpó?rz?dne po?o?enia obserwatora
GLdouble eyex = 0;
GLdouble eyey = 0;
GLdouble eyez = g_fViewDistance;

// wspó?rz?dne punktu w którego kierunku jest zwrócony obserwator,
...
void RenderObjects(void)
{
	...
	float colorBlue[4] = { 0.8,0.5, 0.0, 1.0 };
